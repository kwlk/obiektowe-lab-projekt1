...
/**
 * The map visualizer converts the {@link agh.cs.lab.IWorldMap} map into a string
 * representation.
 *
 * @author apohllo
 */
public class MapVisualizer {
   /* private static final String EMPTY_CELL = " ";
    ...
    private agh.cs.lab.IWorldMap map;

    *//**
     * Initializes the MapVisualizer with an instance of map to visualize.
     * @param map
     *//*
    public MapVisualizer(agh.cs.lab.IWorldMap map) {
        this.map = map;
    }
